...
arm : main-arm.s
	...
	$(CROSS_COMPILER)gcc -mcpu=cortex-m33 -mthumb main.c -nostdlib -ffreestanding -c -o main.o # Compile C without linking
	$(CROSS_COMPILER)gcc -mcpu=cortex-m33 -mthumb -T link-arm.ld picobin.s start.o main.o -static -nostdlib -o arm.elf # Linking everything, producing an ELF
